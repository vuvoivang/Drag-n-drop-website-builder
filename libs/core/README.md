...
<h1>craft.js</h1>
<a href="https://www.npmjs.com/package/@libs/core">
  <img src="https://img.shields.io/npm/v/@libs/core?color=%232680eb&label=NPM&logo=npm&logoColor=%232680eb&style=for-the-badge">
</a>
<img src="https://img.shields.io/npm/l/@libs/core?color=%23000&style=for-the-badge">
...
import {Editor, Frame, Canvas, Selector} from "@libs/core";
const App = () => {
  return (
    <div>
...
```jsx
import {useEditor, useNode} from "@libs/core";
const Container = () => {
...
- **[@libs/layers](https://github.com/prevwong/craft.js/tree/master/packages/layers)** A Photoshop-like layers panel
